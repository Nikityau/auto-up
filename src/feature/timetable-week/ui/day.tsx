...
import Arrow from "../../week-switcher/ui/arrow";
...
const DayGrid = ({ date, children}:Props) => {
  ...
  const imgByDay = (day: number) => {
    switch (day) {
      case 0: return sunday_img
      case 1: return monday_img
      case 2: return tuesday_img
      case 3: return wednesday_img
      case 4: return thursday_img
      case 5: return friday_img
      case 6: return saturday_img
    }
  }
